...
@Entity("")
@Index("sqlite_autoindex_datiEstesiCodificati_2",["ArolCode",],{unique:true})
@Index("sqlite_autoindex_datiEstesiCodificati_1",["ID",],{unique:true})
export class datiEstesiCodificati {
